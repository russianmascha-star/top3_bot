...
# НАСТРОЙКИ ПРОКСИ (если используете) - раскомментируйте и укажите свои
# PROXY = "http://user:pass@ip:port"  # или просто "http://ip:port"
# ===================================================
...
# ========== ВСТАВЬТЕ СВЕЖИЕ ЗАГОЛОВКИ ИЗ БРАУЗЕРА СЮДА ==========
HEADERS = {
    # Базовые
    ...
    # Куки (скопируйте заново из браузера!)
